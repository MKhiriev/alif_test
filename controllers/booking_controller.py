from utils.date_time import get_date, get_time, to_unix
...
class BookingController:
    ...
    def convert_bookings_to_human_readable_format(self, bookings):
        ...
        for booking in bookings:
            ...
            human_readable_bookings.append(f"Booking #{booking.booking_id}. Room # {room.number}. Time: {date} {time_start} - {time_end}. Booked by {user}")

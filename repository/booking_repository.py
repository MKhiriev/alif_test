...
class BookingRepository:
    ...
    def get_bookings_by_room_id_and_booking_time(self, room_id, unix_booking_start_time, unix_booking_end_time):
        conn = sqlite3.connect(self.database)
        cursor = conn.cursor()
    ...
    def add_room_booking(self, user_id, room_id, unix_booking_start_time, unix_booking_end_time):
